<template>
    <!-- Đây là sử dụng router bình thường nhưng xem trên (RHP Team Youtube ) 
        thì nên sử dụng theo name vì khi mình thay đổi đường dẫn router thì nó không ảnh hưởng gì 
    -->
